...
/**
 * Find the first file named 'Selleckfile.js' in the current directory or the
 ...
 *
 * @method useSelleckfileIfAvailable
 */
function useSelleckfileIfAvailable() {
    var selleckfile,
        filePath = findup('Selleckfile.js', { nocase: true });
...
exports.useSelleckfileIfAvailable = useSelleckfileIfAvailable;
